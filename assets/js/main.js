...
/*$(window).scroll(function() {
    ...
    var calidad = "7",
        ...
        pag_cat = 0; 
    blog[0] = new Array(5);
    blog[0][0] = "assets/images/blog/img-13.jpg";
    ...
    blog[0][4] = "impuestos";
    blog[1] = new Array(5);
    blog[1][0] = "assets/images/blog/img-14.jpg";
    ...
    blog[1][4] = "noticias";
    blog[2] = new Array(5);
    blog[2][0] = "assets/images/blog/img-15.jpg";
    ...
    blog[2][4] = "noticias";
    blog[3] = new Array(5);
    blog[3][0] = "assets/images/blog/img-16.jpg";
    ...
    blog[3][4] = "noticias";
    blog[4] = new Array(5);
    blog[4][0] = "assets/images/blog/img-17.jpg";
    ...
    blog[4][4] = "noticias";
    blog[5] = new Array(5);
    blog[5][0] = "assets/images/blog/img-18.jpg";
    ...
    blog[5][4] = "noticias";
    blog[6] = new Array(5);
    blog[6][0] = "assets/images/blog/img-19.jpg";
    ...
    blog[6][4] = "noticias";
    blog[7] = new Array(5);
    blog[7][0] = "assets/images/blog/img-20.jpg";
    ...
    blog[7][4] = "calidad";
    blog[8] = new Array(5);
    blog[8][0] = "assets/images/blog/img-21.jpg";
    ...
    blog[8][4] = "noticias";
    blog[9] = new Array(5);
    blog[9][0] = "assets/images/blog/img-22.jpg";
    ...
    blog[9][4] = "finanzas";
    blog[10] = new Array(5);
    blog[10][0] = "assets/images/blog/img-23.jpg";
    ...
    blog[11] = new Array(5);
    blog[11][0] = "assets/images/blog/img-24.jpg";
    ...
    blog[11][4] = "economia";
    blog[12] = new Array(5);
    blog[12][0] = "assets/images/blog/img-25.jpg";
    ...
    blog[13] = new Array(5);
    blog[13][0] = "assets/images/blog/img-26.jpg";
    ...
    blog[13][4] = "noticias";
    blog[14] = new Array(5);
    blog[14][0] = "assets/images/blog/img-27.jpg";
    ...
    blog[14][4] = "impuestos";
    blog[15] = new Array(5);
    blog[15][0] = "assets/images/blog/img-28.jpg";
    ...
    blog[15][4] = "noticias";
    blog[16] = new Array(5);
    blog[16][0] = "assets/images/blog/img-29.jpg";
    ...
    blog[16][4] = "noticias";
    blog[17] = new Array(5);
    blog[17][0] = "assets/images/blog/img-30.jpg";
    ...
    $("input[name='filtro-blog']").change(function() {
        ...
        $(".blog-6").removeClass("ocultar-blog");
          if(pag_publicaciones > 1 ){
            ...
            for (var i = blog.length - 1; i >= blog.length - 6; i--) {
              ...
              $(".blog-"+ x +" .link-blog-1").attr("href","post-blog/" + i + ".html");
              $(".blog-"+ x +" .link-blog-pos").attr("href","post-blog/" + i + ".html");
              x = x + 1;
            }
      ...
      if (array_cat.length > 0){
        ...
        for(var i = 0 ; i < dato; i++) {
          ...
          $(".blog-"+ y +" .link-blog-1").attr("href","post-blog/" +  array_cat[i] + ".html");
          $(".blog-"+ y +" .link-blog-pos").attr("href","post-blog/" + array_cat[i] + ".html");
          y = y + 1;
        }
      }
      if(pag_cat > 1) {
    ...
    $(".pag-item").on("click", function() {
      ...
      if(array_cat.length > 0 && pag_cat > 0){
        ...
        for (var i = inicial; i < final; i++) {
          ...
          $(".blog-"+ x +" .link-blog-1").attr("href","post-blog/" + array_cat[i] + ".html");
          $(".blog-"+ x +" .link-blog-pos").attr("href","post-blog/" + array_cat[i] + ".html");
          x = x + 1;
        }  
      }else {
